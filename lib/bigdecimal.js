...
var BigDecimal = (function () {
    ...
    var bd = function (number) {
        ...
        for (i = 0; i < fraction.length && i < bd.FRACTION_DIGITS; i++) {
    ...
    bd.prototype.gte = function (number) {
        return ! this.lt(number);
    };

    bd.prototype.gt = function (number) {
        return ! this.lte(number);
    };
